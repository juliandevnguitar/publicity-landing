...
function About() {
  return (
    <main className="main-template main-grid">
            ...
            <p className="subtitle">We’re two brothers from Chicago. We can help you with SEO, SEM, content marketing and whatever else.</p>
            
            <img className="main-image" src="../about-me.jpg" alt="a man wearing goggles" />
